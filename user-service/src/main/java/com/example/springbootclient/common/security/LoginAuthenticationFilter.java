...
import com.example.springbootclient.common.dto.Result;
...
//        String accessToken = jwtProvider.createJwtAccessToken(userId, request.getRequestURI(), roles);
        String accessToken = jwtProvider.createJwtAccessToken(userName);
